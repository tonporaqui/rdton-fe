...
const confirmModalAction = (userData: User) => {
	console.log('Confirm modal action with user data:', userData)
	// Aquí puedes agregar la lógica para crear/editar/borrar el usuario
	closeModal()
}
